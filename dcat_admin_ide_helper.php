...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection dkp
     ...
     * @method Grid\Column|Collection dkp(string $label = null)
     ...
     * @property Show\Field|Collection dkp
     ...
     * @method Show\Field|Collection dkp(string $label = null)
